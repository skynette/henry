...
function Login() {
	return (
		<div className="flex flex-col md:flex-row min-h-screen bg-registerBg">
			...
			{/* Right section */}
			<div className="md:w-1/2 flex flex-col justify-center m-auto mt-12 md:mt-60 items-center">
				<form className="w-full max-w-md px-14">
					<h2 className="text-3xl text-center text-gray-800 mb-8 py-6">Welcome Back</h2>
					<div className="mb-4">
